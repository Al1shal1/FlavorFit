...
CREATE TABLE "nutrition_facts" (
    ...
    "carbonydrates" DOUBLE PRECISION NOT NULL,
...
-- CreateTable
CREATE TABLE "recipe_tegs" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "recipe_tegs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "recipe_tegs_name_key" ON "recipe_tegs"("name");
...
-- AddForeignKey
ALTER TABLE "_RecipeToRecipeTag" ADD CONSTRAINT "_RecipeToRecipeTag_B_fkey" FOREIGN KEY ("B") REFERENCES "recipe_tegs"("id") ON DELETE CASCADE ON UPDATE CASCADE;

/*
  ...
  - You are about to drop the column `fats` on the `nutrition_facts` table. All the data in the column will be lost.
  ...
  - You are about to alter the column `carbonydrates` on the `nutrition_facts` table. The data in that column could be lost. The data in that column will be cast from `DoublePrecision` to `Decimal(65,30)`.
...
*/
-- AlterTable
ALTER TABLE "nutrition_facts" DROP COLUMN "fats",
ALTER COLUMN "proteins" SET DATA TYPE DECIMAL(65,30),
ALTER COLUMN "carbonydrates" SET DATA TYPE DECIMAL(65,30),
